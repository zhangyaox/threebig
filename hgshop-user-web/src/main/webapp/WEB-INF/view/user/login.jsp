...
<meta name="theme-color" content="#563d7c">
  ...
  <input type="password" id="inputPassword" name="pwd" class="form-control" placeholder="密码" >
  
  <button class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button>
  <button type="button" class="btn btn-success btn-primary btn-block" onclick="zc()">注册</button>
